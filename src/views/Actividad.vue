  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Fibras textiles
        p.mb-4 Comprender el origen de las fibras como base del proceso de tejido y confección textil por medio de la relación conceptual y su ejemplificación.
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Tejidos
        p.mb-4 Comprender los tejidos en cuanto a su fabricación, uso y defectos para el correcto control de calidad de sus procesos. 
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
